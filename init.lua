...
require('lazy').setup({
  ...
  --     prompts = {
  --       ExplainWorks = {
  --         prompt = 'Explain how this works as concisely as possible',
  --         system_prompt = 'You are very good at explaining stuff. Please explain how this works, as concisely as possible.',
  --         description = 'Explain how this works',
  --       },
  --       FixBug = {
  --         prompt = 'Fix this bug',
  --         system_prompt = 'You are very good at fixing bugs. Please fix this bug.',
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- it can fuzzy find! It's more than just a "nvim-tree/nvim-tree.lua", it can search
